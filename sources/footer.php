				...
				<div class="row">
					...
					<div class="col-sm-3">
						<div class="footer-widget social-widget">
							...
							<ul>
								<li><a href="https://www.facebook.com/eTransfer"><i class="fa fa-facebook-official"></i>Facebook</a></li>
								<li><a href="https://www.twitter.com/eTransfer"><i class="fa fa-twitter-square"></i>Twitter</a></li>
								<li><a href="https://plus.google.com/eTransfer"><i class="fa fa-google-plus-square"></i>Google+</a></li>
								<li><a href="https://www.youtube.com/c/eTrasfer"><i class="fa fa-youtube-play"></i>youtube</a></li>
							</ul>
						</div>
					</div><!-- footer-widget -->
